{{-- to check if the session works or not --}} @if (session('success'))
                ...
                <div class="auth-container">
                    ...
                    >
                        ...
                        <div class="auth-header">
                            <h2>Join Fresh Clean</h2>
                            <p>
                                Create your account for premium laundry service
                            </p>
                        </div>
                        ...
                        <div class="auth-form-group">
                            ...
                            >
                            {{-- the reason why the name="password_confirmation"
                            is because Laravel’s validation rule confirmed
                            checks for password_confirmation --}}
                            <input
                                type="password"
